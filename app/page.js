    ...
    <div className="page">
          ...
          <section className="info-panel fade-in">
            <div className="info-top">
              ...
              <div className="info-ratio-box">
                ...
                <div className="info-ratio-val">{formatRatio(selectedTicker)}</div>
              </div>
            </div>
        ...
        {synthetic !== null && effectiveIntl !== null && brecha !== null && (
          <section className={`result-panel fade-in ${brecha > 0 ? "result-caro" : "result-barato"}`}>
            ...
            <div className="breakdown">
              ...
              <div className="b-row">
                <span className="b-label">× Ratio {formatRatio(selectedTicker)}</span>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; }
        ...
        .info-ratio-label { font-size: 13px; color: var(--text3); margin-bottom: 4px; text-transform: uppercase; letter-spacing: 1px; }
        .info-ratio-val {
